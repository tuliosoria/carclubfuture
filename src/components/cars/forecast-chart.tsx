        ...
        <AreaChart data={data} margin={{ top: 10, right: 20, left: 0, bottom: 0 }}>
          <defs>
            <linearGradient id="upBand" x1="0" x2="0" y1="0" y2="1">
              <stop offset="0%" stopColor="#b9975b" stopOpacity={0.5} />
              <stop offset="100%" stopColor="#b9975b" stopOpacity={0.05} />
            </linearGradient>
          ...
          <Area type="monotone" dataKey="optimistUsd" stroke="#b9975b" fill="url(#upBand)" name="Optimist" />
