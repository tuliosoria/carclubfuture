  ...
  return (
    <Card className="overflow-hidden transition hover:border-accent/40">
      ...
      <CardHeader>
        ...
        {segmentLabel ? (
          <p className="text-xs uppercase tracking-wide text-muted-foreground">{segmentLabel}</p>
        ) : (
          <p className="text-xs uppercase tracking-wide text-muted-foreground">Catalog entry</p>
        )}
      </CardHeader>
